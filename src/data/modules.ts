...
const STATIC: Record<string, StaticConfig> = {
  ...
  inbox: {
    ...
    subFeatures: [
      ...
      { name: 'Saved assignee filter presets — save / rename / delete', done: false },
      { name: 'Saved assignee filter presets — pin to top bar toggle', done: false },
      { name: 'Tag filter popover (multi-select with search)', done: false },
      { name: 'Assignee filter popover (multi-select with search)', done: false },
