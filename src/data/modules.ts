...
const STATIC: Record<string, StaticConfig> = {
  ...
  inbox: {
    ...
    subFeatures: [
      ...
      { name: 'Account / channel selector in header', done: false },
      { name: 'Search messages and contacts', done: false },
      { name: 'Pinned filter presets', done: false },
      ...
      { name: 'Active filter display chips', done: false },

      // Message thread
      { name: 'Message thread (chronological)', done: true },
      { name: 'Date dividers in thread', done: false },
      { name: 'Auto-scroll to latest message', done: false },
      { name: 'Scroll-to-bottom button', done: false },
      { name: 'Load more messages (pagination)', done: false },
      { name: 'Quoted / reply message preview', done: true },
      { name: 'Message status indicators (sent/delivered/read)', done: false },
      ...
      { name: 'Link preview', done: false },
      { name: 'Location message', done: false },
      { name: 'Contact card (vCard)', done: false },
      { name: 'Interactive buttons message', done: false },
      { name: 'Poll message with options', done: false },
      { name: 'Product / catalog message', done: false },
      { name: 'Order message with details', done: false },
      { name: 'Message reactions display', done: false },
      { name: 'Sticker message', done: false },
      { name: 'Voice-to-text transcription', done: false },
      { name: 'Unsupported message type fallback', done: false },
      ...
      { name: 'Button builder in compose (up to 3)', done: false },
      { name: 'Template message selection', done: false },
      { name: 'Signature editor and management', done: false },
      { name: 'Variable / dynamic text insertion', done: false },
      ...
      { name: 'Forward message to other contacts', done: false },
      { name: 'Delete message (with confirmation)', done: false },
      { name: 'React to message', done: false },

      // Bulk operations
      { name: 'Bulk action bar (select all)', done: true },
      { name: 'Bulk assign', done: false },
      { name: 'Bulk tag', done: false },
      { name: 'Bulk export', done: false },

      // Right panel — Contact profile
      { name: 'Contact profile side panel', done: false },
      { name: 'Custom fields display and edit', done: false },
      { name: 'Contact active-hours chart', done: false },
      { name: 'Contact notes (CRUD)', done: false },
      { name: 'Contact tags management', done: false },
      { name: 'Linked tickets / CRM board', done: false },
      { name: 'Linked orders in profile', done: false },
      { name: 'Group participants list', done: false },
      { name: 'Drag-and-drop reorderable profile sections', done: false },

      // Inbox settings / config
      { name: 'Inbox settings modal (auto-assign, working hours)', done: false },
      { name: 'Notes tab (internal team notes)', done: false },
      { name: 'Image lightbox / media viewer', done: true },
      { name: 'Message bubbles redesign (SaaS aesthetic)', done: true },
    ],
    notes: 'Core thread, filters, and compose bar done. Contact profile panel, message types beyond basic, compose features (scheduling, templates, buttons, signature) not yet rebuilt.',
  },
  ...
  channels: {
    ...
    subFeatures: [
      ...
      { name: 'Channel connection status display', done: false },
      { name: 'Broken connection detection + alert popup', done: false },
      { name: 'Rescan / reconnect flow', done: false },
      { name: 'Reload channel modal', done: false },
      { name: 'Pending messages confirmation modal', done: false },
      { name: 'Verify phone number dialog', done: false },
      { name: 'Channel profile update', done: false },
      { name: 'ISV terms submission', done: false },
      { name: 'Sender ID submission', done: false },
      { name: 'Channel limitations info modal', done: false },
      { name: 'Credit requirements display per channel', done: false },
    ],
    notes: 'All onboarding dialogs added. Connection health, broken connection alerts, verify phone, and channel-level config not yet rebuilt.',
  },
