...
const STATIC: Record<string, StaticConfig> = {
  ...
  inbox: {
    ...
    subFeatures: [
      ...
      { name: 'Pinned filter top bar — collapsible / expandable with "+N more"', done: false },
      { name: 'Pinned filter top bar — horizontal scroll for overflow', done: false },
      { name: 'Pinned filter top bar — active / inactive color state', done: true },
      { name: 'Pinned filter top bar — hover: edit / unpin / delete actions', done: false },
      { name: 'Pinned filter top bar — inline unpin cross on hover', done: false },
      { name: 'Pin filter dialog (create / edit named filters)', done: true },
      { name: 'Pin filter dialog — emoji picker (24 preset options)', done: false },
      { name: 'Pin filter dialog — rule builder (field → operator → value)', done: false },
      { name: 'Pin filter dialog — AND/OR multi-rule logic', done: false },
      { name: 'Pin filter dialog — operators: is / is-not / is-all-of / contains / is-empty', done: false },
      { name: 'Pin filter dialog — rule segments (added-between, added-by)', done: false },
      { name: 'Pin filter dialog — field: channel', done: false },
      { name: 'Pin filter dialog — field: tags', done: false },
      { name: 'Pin filter dialog — field: assignee', done: false },
      { name: 'Pin filter dialog — field: custom fields', done: false },
      { name: 'Pin filter dialog — field: unread / archived / groups / individuals / mentions', done: false },
      ...
      { name: 'Pin filter dialog — name input (max 20 chars, uniqueness validation)', done: false },
      { name: 'Pin filter dialog — max 10 filters limit enforcement', done: false },
      { name: 'Pin filter dialog — convertRulesToFilters / convertFiltersToRules round-trip', done: false },
      ...
      { name: 'Filter panel — pinned filters section (collapsible list)', done: false },
      { name: 'Active filter display chips', done: true },
      // ── Tag filters ───────────────────────────────────────────────────────
      { name: 'Saved tag filter presets (useSavedTagFilters)', done: true },
      { name: 'Saved tag filter presets — sort by last used then name', done: false },
      { name: 'Saved tag filter presets — duplicate name auto-numbering', done: false },
      { name: 'Saved tag filter presets — save / rename / delete', done: false },
      { name: 'Saved tag filter presets — pin to top bar toggle', done: false },
      { name: 'Saved tag filter presets — no protected defaults (all deletable)', done: false },
      { name: 'Saved tag filter presets — per-team localStorage scope', done: false },
      { name: 'Tag filter popover — search box (server-side, paginated)', done: false },
      { name: 'Tag filter popover — IS / IS NOT toggle', done: false },
      { name: 'Tag filter popover — AND / OR logic toggle (IS mode only)', done: false },
      { name: 'Tag filter popover — tag list with color icon + checkbox', done: false },
      { name: 'Tag filter popover — scroll pagination (load more tags)', done: false },
      { name: 'Tag filter popover — "No tags found" empty state', done: false },
      { name: 'Tag filter popover — opposite list enforcement (IS vs IS NOT)', done: false },
      { name: 'Tag filter popover — auto-generated filter name from selections', done: false },
      { name: 'Tag filter popover — custom name override', done: false },
      { name: 'Tag filter popover — Save & Apply / Cancel buttons', done: false },
      { name: 'Tag filter sidebar section — collapsible with count + add button', done: false },
      { name: 'Tag filter sidebar section — "No tag filters yet" empty state', done: false },
      { name: 'Tag filter sidebar row — name, live chat count badge, active highlight', done: false },
      { name: 'Tag filter sidebar row — more menu: pin / edit / delete', done: false },
      { name: 'Tag filter — AND logic (all tags must match)', done: false },
      { name: 'Tag filter — OR logic (any tag matches)', done: false },
      { name: 'Tag filter — IS NOT mode (none of these tags)', done: false },
      { name: 'Tag filter — last used timestamp update on apply', done: false },

      // ── Assignee filters ──────────────────────────────────────────────────
      { name: 'Saved assignee filter presets (useSavedAssigneeFilters)', done: true },
      { name: 'Saved assignee filter presets — default: Assigned to Me / Unassigned (non-deletable)', done: false },
      { name: 'Saved assignee filter presets — sort by last used then name', done: false },
      { name: 'Saved assignee filter presets — duplicate name auto-numbering', done: false },
      { name: 'Saved assignee filter presets — save / rename / delete (custom only)', done: false },
      { name: 'Saved assignee filter presets — pin to top bar toggle', done: false },
      { name: 'Saved assignee filter presets — per-team localStorage scope', done: false },
      { name: 'Assignee filter popover — search box (client-side on loaded members)', done: false },
      { name: 'Assignee filter popover — IS / IS NOT toggle', done: false },
      { name: 'Assignee filter popover — "Unassigned" option (IS mode only)', done: false },
      { name: 'Assignee filter popover — member list with checkboxes (scrollable)', done: false },
      { name: 'Assignee filter popover — "No assignees found" empty state', done: false },
      { name: 'Assignee filter popover — opposite list enforcement (IS vs IS NOT)', done: false },
      { name: 'Assignee filter popover — auto-generated filter name from selections', done: false },
      { name: 'Assignee filter popover — custom name override', done: false },
      { name: 'Assignee filter popover — Save & Apply / Cancel buttons (disabled when empty)', done: false },
      { name: 'Assignee filter sidebar — "Assigned to Me" with live chat count', done: false },
      { name: 'Assignee filter sidebar — "Unassigned" with live chat count', done: false },
      { name: 'Assignee filter sidebar section — collapsible with count + add button', done: false },
      { name: 'Assignee filter sidebar section — "No assignee filters yet" empty state', done: false },
      { name: 'Assignee filter sidebar row — name, live chat count badge, active highlight', done: false },
      { name: 'Assignee filter sidebar row — more menu: pin / edit / delete', done: false },
      { name: 'Assignee filter — IS mode (assigned to all selected)', done: false },
      { name: 'Assignee filter — IS NOT mode (not assigned to any selected)', done: false },
      { name: 'Assignee filter — last used timestamp update on apply', done: false },
