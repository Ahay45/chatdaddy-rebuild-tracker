...
const STATIC: Record<string, StaticConfig> = {
  ...
  crm: {
    ...
    notes: 'Contacts list, filters, active chips, bulk ops, export all done. Board/stage CRUD, drag-and-drop, ticket detail (5 tabs: notes, activity, AI, credits, assignee) all done. Contact active hours heatmap + best send time added. Missing: named views per board, ticket more-options menu, inline stage/contact selectors, admin section, table column visibility, AI CRM profile, bulk move bar, DISC analysis, tag/custom-field managers.',
  },
  ...
  channels: {
    ...
    notes: 'Full rebuild complete. WabaCreatingAccountModal (animated 5-step progress), ChannelSettingsDialog with all 8 sections (sync history, WABA settings, auto-assign, automation, comment moderation, privacy, advanced incl. geo location, danger zone with clear queue + remove data), credit cost badges on AddChannelDialog tiles.',
  },
