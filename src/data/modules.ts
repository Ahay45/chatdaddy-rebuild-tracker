...
const STATIC: Record<string, StaticConfig> = {
  ...
  broadcasts: {
    ...
    notes: 'List, create dialog/page, progress dialog, flow selection, scheduling, channel type, and analytics KPI/charts done. Still missing: recipient list viewer, speed config, WABA tier logic, heatmap, cost efficiency.',
  },
